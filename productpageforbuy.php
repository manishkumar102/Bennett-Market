...
<head>
  ...
  <title>Product Page For Buy</title>
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            session_start();
				...
				$link = mysqli_connect('localhost', 'root', '', 'maarket'); 
		if(!$link) 
		{ 
...
$pid=$_POST['view'];
		...
		*/
		...
		$query="select * from pimage where pid='$pid'";
...
<section class="features14 cid-qBXr2p7udb" id="features14-2f" data-rv-view="2975">
    ...
    <div class="container align-center">
        <h2 class="mbr-section-title pb-3 mbr-fonts-style display-2"><?php
		$pid=$_POST['view'];
								$link = mysqli_connect('localhost', 'root', '', 'market');
if(!$link) 
		{ 
		...
		*/
		$query="select * from s_product where p_id='$pid'";
		$result=mysqli_query($link,$query);
		$result1=mysqli_fetch_array($result , MYSQL_ASSOC);
		if($result1['name'])
		echo $result1['name'];
...
if(!$link) 
		...
		*/
		...
		{echo $result1['description'];echo "</br></br>";
		echo $result1['category'];}
	else
        ...
        <div class="media-container-column">
            <div class="row justify-content-center">
                ...
                <div class="card p-6 col-12 col-sm-6 col-sm-6 ">
                <div class="media pb-3">
                    ...
                    <div class="media-body">
                        <h4 class="card-title py-2 align-center mbr-fonts-style display-5">
                                Rs.<?php
								$pid=$_POST['view'];
								$link = mysqli_connect('localhost', 'root', '', 'market');
if(!$link) 
		...
		*/
		...
		?>
            ...
            <div class="media-content">
                <h1 class="mbr-section-title mbr-white pb-3 mbr-fonts-style display-1">                        <?php
				$pid=$_POST['view'];
								$link = mysqli_connect('localhost', 'root', '', 'Market');
if(!$link) 
		{ 
		...
		echo "NO DESCRITION PROVIDED BY SELLER";
             ...
             echo      ' </p>
				...
				<input type="number" class="btn btn-default btn-sm" placeholder="Quantity"name="qty"/>
                   <input type="submit" name="buy" value="BUY " class="btn btn-primary"  /></form></div>
            </div>';?>
        </div>
    </div>
