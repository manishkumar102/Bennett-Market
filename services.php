    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="services.php">
                         <img src="assets/images/download.png"  title="" media-simple="true" style="height: 3.8rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="services.php">BU Market</a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            session_start();
				...
				$link = mysqli_connect('localhost', 'root', '', 'market'); 
		if(!$link) 
		{ 
		...
		//Select database 
		/*
		$db = mysqli_select_db($link,'market'); 
		if(!$db) 
		{ 
    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">Welcome Back to&nbsp;<br>BU Market</h1>
        ...
        <div class="media-container-row">
            ...
            <div class="card  col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box align-center">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                       the products you find useful. All the products here are verified. BU Market provides a platform to buy the products you find useful easily by contacting the seller personally.
                    </p>
            ...
            <div class="card  col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box align-center">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                       the products you find useful. All the products here are verified. BU Market provides a platform to rent the products you find useful easily by contacting the seller personally.
                    </p>
            ...
            <div class="card  col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box align-center">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                       the products that you don't want to use anymore. BU Market provides a platform to sell the products that you don't want to use anymore easily by contacting the buyer .
                    </p>
            ...
            <div class="card  col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box align-center">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                       the products that you want to lend sometime . BU Market provides a platform to rent the products that are not in use by you at present and earn royalty for the same .
                    </p>
        ...
        <div class="media-container-row content text-white">
            <div class="col-12 col-md-4">
                <div class="media-wrap">
                    <a href="services.php">
                        <img src="assets/images/download.png" height:"300px" width:"300px" title="" media-simple="true"/>
                    </a>
                </div>
            </div>
            <div class="col-12 col-md-4 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">Bennett University</p>
            </div>
            <div class="col-12 col-md-4 mbr-fonts-style display-7">
                <h5 class="pb-3">
            	<br>
