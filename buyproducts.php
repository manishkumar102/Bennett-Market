...
if(!$link) 
		...
		*/
		$sql="select * from s_product where quantity>0 and username<>'$uid'";
		$result=mysqli_query($link,$sql);
		
		
		while($row = mysqli_fetch_row($result)){
			$sql2="select * from pimage where pid=$row[0];";
            ...
            <div class="card p-3 col-12 col-md-6 col-sm-12">
                <div class="card-wrapper ">
                    <div class="card-img">
						...
						<form action="productpageforbuy.php" method="post" >
						<input type="hidden" name="view"  value='.$row[0].' >
                            <input type="submit" name="buysproduct" value="EXPLORE" class="btn btn-primary display-4"/>
						</form>
                        </div>
...
if(!$link) 
		...
		*/
		$sql="select * from s_product where category='Electronics' and quantity>0 and username<>'$uid'";
		$result=mysqli_query($link,$sql);
...
if(!$link) 
		...
		*/
		$sql="select * from s_product where category='Clothings' and quantity>0 and username<>'$uid'";
		$result=mysqli_query($link,$sql);
...
if(!$link) 
		...
		*/
		$sql="select * from s_product where category='Books' and quantity>0 and username<>'$uid'";
		$result=mysqli_query($link,$sql);
...
if(!$link) 
		...
		*/
		$sql="select * from s_product where category='Others' and quantity>0 and username<>'$uid'";
		$result=mysqli_query($link,$sql);
